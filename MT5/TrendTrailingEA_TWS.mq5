...
//|   - EMBEDDED: TWS Gold F1 pullback engine (200/20/50 EMA trend    |
//|     pullback, swing stop, 3R target, 2R banking, risk-% sizing)   |
//|     running independently on its own magic number (50502).        |
//|                                                                  |
//|  v6.10 changes:                                                  |
...
void DashPanel()
  {
   ...
   ObjectSetInteger(0, obj, OBJPROP_YSIZE, 354);
  }
...
void UpdateDashboard()
  {
   ...
   DashLabel(r++, "TrendTrailing v6.3 +TWS " + _Symbol, cHead);
...
void OnTick()
  {
   ...
   TwsOnTick();                       // TWS pullback engine (own magic, independent)
